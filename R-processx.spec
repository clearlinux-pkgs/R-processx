...
Version  : 3.8.6
Release  : 76
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/processx_3.8.6.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/processx_3.8.6.tar.gz
...
%package dev
Summary: dev components for the R-processx package.
Group: Development
Requires: R-processx-lib = %{version}-%{release}
Provides: R-processx-devel = %{version}-%{release}
Requires: R-processx = %{version}-%{release}

%description dev
dev components for the R-processx package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740180714
...
/usr/lib64/R/library/processx/tests/testthat/_snaps/newcli/err-output.md
/usr/lib64/R/library/processx/tests/testthat/_snaps/oldcli/err-output.md
