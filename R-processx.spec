...
Version  : 2.0.0.1
Release  : 1
URL      : https://cran.r-project.org/src/contrib/processx_2.0.0.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/processx_2.0.0.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1523771460
...
/usr/lib64/R/library/processx/internals.md
